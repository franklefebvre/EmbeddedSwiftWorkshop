...
static ble_uuid128_t service_class_uuid;
...
static void start_advertising(void) {
    ...
    rsp_fields.uuids128 = &service_class_uuid;
...
int gap_init(const char *deviceName, const ble_uuid_t *service_uuid) {
    /* Quick & dirty: initialize service uuid */
    service_class_uuid = *BLE_UUID128(service_uuid);
